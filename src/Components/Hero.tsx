    ...
    return (
        ...
        <div className='h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden'>
            ...
            <h1 className='p-5 font-bold text-6xl z-10'>
                ...
                <span className='text-gray'>I&rsquo;m <span className='font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-red-900'>Youssef Bounouacha</span> </span>
            </h1>
            <h1 className='p-5 font-bold text-6xl z-10'>
