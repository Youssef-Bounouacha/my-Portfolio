...
export default function About({ }: Props) {
    return (
        <div className='flex flex-col relative h-screen md:space-x-10 text-center md:text-left md:flex-row max-w-4xl mx-auto px-10 justify-evenly items-center'>
            <h3 className='absolute top-10 md:top-24  mb-64 uppercase tracking-[12px] text-gray text-xl md:text-2xl'>About</h3>
            <motion.img
                initial={{
                    x: -300,
                    opacity: 0,
                ...
                src='/images/pdp.jpg'
                className='mt-[40%] md:mt-[10%] md:mb-18 flex-shrink-0 h-56 w-56 rounded-full object-top object-cover md:rounded-t-xl md:rounded-b-xl md:h-[320px] md:w-64'
            />
            <div className='flex flex-col  md:mb-0  md:mt-[20%] md:px-5 '>
                ...
                <button className='group w-fit px-6 py-3 my-6 mx-auto font-semibold hover:ring-2 dark:ring-white ring-black hover:scale-105 duration-500 flex items-center uppercase rounded-md bg-gradient-to-r from-red-400 to-red-900'>
                    <a href='pdf/YOUSSEF_BOUNOUACHA CV.pdf' download>my resume</a>
